...
import 'package:zems/logic/chat/chat_cubit.dart';
import 'package:zems/data/model/chat_message_model.dart';
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Gap(16.h),
          Text("Start Chatting With the Chatbot",
          ...
          Wrap(
            ...
            children: [
              _buildPromptChip('How to perform CPR?'),
              _buildPromptChip('Natural remedies for TB'),
              _buildPromptChip('First aid for burns'),
              _buildPromptChip('Managing diabetes with local diet'),
              _buildPromptChip('Malaria prevention'),
              _buildPromptChip('Mental health tips'),
            ],
          ),
        ],
      ),
