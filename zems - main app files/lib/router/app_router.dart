...
import '../view/screen/auth/guest_mode_screen.dart';
import '../view/screen/personal_health/personal_health_screen.dart';
...
import '../view/screen/emergency/emergency_contacts_screen.dart';
import '../view/screen/emergency/add_edit_contact_screen.dart';
...
abstract class AppRouter {
  ...
  static Route<dynamic>? onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RouteManager.personalHealth:
        return PageTransitionManager.materialPageRoute(
          const PersonalHealthScreen(),
        );
      ...
      case RouteManager.emergencyContacts:
        return PageTransitionManager.materialSlideTransition(
          const EmergencyContactsScreen(),
        );
      case RouteManager.addEditContact:
        final contact = settings.arguments as EmergencyContact?;
        return PageTransitionManager.materialSlideTransition(
