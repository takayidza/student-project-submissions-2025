am4core.ready(function() {
    ...
    // Create chart
    var chart = am4core.create("hourly_wateruse_chart", am4charts.XYChart);
    ...
    fetch("/apimonitor/womp-hourly-water-usage/")
        ...
        .then(data => {
            ...
            chart.data = data.map(entry => ({
                ...
                usage_type: entry.predicted_water_usage < 0 ? "usage" : "refill",  // logic based on ORIGINAL sign
